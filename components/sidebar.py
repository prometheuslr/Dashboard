...
layout = dbc.Col([
    ...
    html.P("BY ASIMOV AND LUCAS", className="text-info"),
    html.Hr(),  
        ...
        dbc.Modal([
            ...
            dbc.ModalBody([
                dbc.Row([
                    dbc.Col([
                        dbc.Label('Descrição:'),
                        dbc.Input(placeholder="Ex. Compras, contas, gasolina....", id="txt-despesa"),
...
def toggler_modal_despesa(n1, is_open):
    if n1:
        return not is_open
